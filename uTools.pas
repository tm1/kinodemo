...
{$IFDEF uTools_DEBUG}
initialization
  DEBUGMess(0, 'uTools.Init');
{$ENDIF}

{$IFDEF uTools_DEBUG}
finalization
  DEBUGMess(0, 'uTools.Final');
{$ENDIF}
