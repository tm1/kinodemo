...
VCL Classes in this Unit:
  TTCPClient - A TCP Client (derived from TCusSok)
  TTCPServer - A TCP Server (derived from TCusSok)
  TUDPClient - A UDP Client (derived from TCusSok)
  TUDPServer - A UDP Server (derived from TCusSok)

Other classes ni this Unit:
  TCusSok - A generic base class for other socket classes
...
function TCusSok.SocketWriteBufferTo(Socket: TSocket; Buffer: Pointer; Size, Flag: integer; var SockAddrIn: TSockAddrIn): integer;
begin
...
function TCusSok.SocketReadBufferFrom(Socket: TSocket; Buffer: Pointer; Size, Flag: integer; var SockAddrIn: TSockAddrIn): integer;
var
  Len: integer;
begin
  Len:= SizeOf(SockAddrIn);
